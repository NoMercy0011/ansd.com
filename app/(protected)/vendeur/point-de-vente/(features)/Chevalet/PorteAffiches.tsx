...
export default function PorteAffiches({item, activeSection, getDevis, getPrix} : ItemProps) {
    ...
    useEffect(() => {
    // --- Logique de Calcul du Prix pour Porte-Affiches/Oriflamme ---
    ...
    // 4. Prix de l'orientation/technologie
    // const orientationSelectionnee = item.orientations!.find(
    //     o => o.id === devisEncours.orientation_id
    // );
    // if (orientationSelectionnee) {
    //     prixUnitaire += Number(orientationSelectionnee.prix);
    // }
                ...
                <div className='flex'>
                  <div ref={particulariteRef} className="w-full lg:w-1/2 scroll-mt-20">
                      <h4 className="font-semibold text-slate-700 dark:text-slate-200 mb-4 flex items-center">
                       ...
                       <div className="mt-3 px-2">
                        <div className="space-y-3">
                            {/* <h1 className='text-sm font-bold ml-2'>Remarque et particularité</h1> */}
                            <div className="relative">
                                <Input
                                    type="text"
