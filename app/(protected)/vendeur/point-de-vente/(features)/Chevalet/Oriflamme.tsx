...
export default function Oriflamme({item, activeSection, getDevis, getPrix} : ItemProps) {
    ...
    if (item.socles && item.socles.length > 0) {
        ...
        // else {
        //     const socleSelectionne = item.socles.find(
        //         s => s.id === devisEncours.socle_id
        //     );
        //     if (socleSelectionne) {
        //         prixUnitaire += Number(socleSelectionne.prix);
        //     }
        // }
    }
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    placeholder="Description de la socle personnalisé"
                                />
                            </div>
                            <div className="relative">
                                <Input
